...
GEOSUBSTRACT_API UClass* Z_Construct_UClass_ACombatEnemySpawner();
...
const UECodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_ACombatEnemySpawner_Statics::InterfaceParams[] = {
	{ Z_Construct_UClass_UCombatActivatable_NoRegister, (int32)VTABLE_OFFSET(ACombatEnemySpawner, ICombatActivatable), false },  // 3369706227
};
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Users_osuy_Data_Projects_GeoSubstract_Source_GeoSubstract_Variant_Combat_AI_CombatEnemySpawner_h__Script_GeoSubstract_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_ACombatEnemySpawner, ACombatEnemySpawner::StaticClass, TEXT("ACombatEnemySpawner"), &Z_Registration_Info_UClass_ACombatEnemySpawner, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ACombatEnemySpawner), 2366196180U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_osuy_Data_Projects_GeoSubstract_Source_GeoSubstract_Variant_Combat_AI_CombatEnemySpawner_h__Script_GeoSubstract_2591217373(TEXT("/Script/GeoSubstract"),
	Z_CompiledInDeferFile_FID_Users_osuy_Data_Projects_GeoSubstract_Source_GeoSubstract_Variant_Combat_AI_CombatEnemySpawner_h__Script_GeoSubstract_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_osuy_Data_Projects_GeoSubstract_Source_GeoSubstract_Variant_Combat_AI_CombatEnemySpawner_h__Script_GeoSubstract_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
